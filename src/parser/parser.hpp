...
namespace parser {
    ...
    void error(String name, lexer::Token pos, String msg, int code, String appendix = "");
    void error(String name, lexer::Token from, lexer::Token to, String msg, int code, String appendix = "");
    void warn(String name, lexer::Token pos, String msg, int code);
    void warn(String name, lexer::Token from, lexer::Token to, String msg, int code);
